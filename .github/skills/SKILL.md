# Mobile Automation Workspace Skill

This repository is mobile-agent specific and framework-specific:
...
Every agent and workflow for this repository must read this file first, then read the task skill:
